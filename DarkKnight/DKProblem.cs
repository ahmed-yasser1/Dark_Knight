...
namespace Problem
{
    ...
    public class Problem : ProblemBase, IProblem
    {
        ...
        public override string ProblemName { get { return "DarkKnight"; } }
        ...
        {            
            ...
            d.X = 3; d.Y = 1;
            int expected = 2;
            int output = DarkKnight.Play(N, s, d);
        ...
        private static void PrintCase(int N, Location s, Location d, int output, int expected)
        {
            ...
            Console.WriteLine("Dark Knight Location (X, Y): {0}, {1}", s.X, s.Y);
